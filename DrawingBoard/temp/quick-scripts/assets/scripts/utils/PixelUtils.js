(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/utils/PixelUtils.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '59edbRdmTZNzafoPXcFDar5', 'PixelUtils', __filename);
// scripts/utils/PixelUtils.ts

Object.defineProperty(exports, "__esModule", { value: true });
//目标图像尺寸
var judgeSize = new cc.Size(28, 28);
var PixelUtils = /** @class */ (function () {
    function PixelUtils() {
    }
    //翻转图像y轴
    PixelUtils.prototype.filpYImage = function (data, size) {
     ...
     * @param size 像素数据size
     */
    PixelUtils.prototype.scalePixels = function (pixelsData, size) {
        var width = size.width;
        var height = size.height;
        ...
        for (var row = 0; row < judgeSize.height; ++row) {
            for (var col = 0; col < judgeSize.width * 4; col += 4) {
     ...
     */
    PixelUtils.prototype.grayPixels = function (pixelsData, dataSize, targetSize) {
     ...
     * @param data 数组
     */
    PixelUtils.prototype.convertToUint8ClampedArray = function (data) {
    ...
    PixelUtils.judegSize = new cc.Size(28, 28);
    return PixelUtils;
}());
exports.default = new PixelUtils();
...
cc._RF.pop();
        ...
        //# sourceMappingURL=PixelUtils.js.map
